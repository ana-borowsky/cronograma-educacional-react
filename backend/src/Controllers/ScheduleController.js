 ...
 class ScheduleController {
  ...
  static async getScheduleByUser (req, res) {
   ...
   static async getWeekScheduleByUser (req, res) {
    try {
      const {idUser} = req.params
      const result = await new ScheduleService().getWeekScheduleByUser(Number(idUser))
  ...
  static async getMonthScheduleByUser (req, res) {
    try {
      const {idUser} = req.params
      const result = await new ScheduleService().getMonthScheduleByUser(Number(idUser))
