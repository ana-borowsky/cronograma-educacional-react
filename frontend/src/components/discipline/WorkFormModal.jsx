...
export const WorkFormModal = ({ isOpen, onClose }) => {
  // 🚨 CORREÇÃO ESSENCIAL: Controla a visibilidade do modal.
  if (!isOpen) return null;

  const handleFormSubmit = (e) => {
    e.preventDefault()
    // A lógica de submit fecha o modal
    onClose()
  }
  ...
  return (
    <div
      ...
      // Clique no overlay (fora do formulário) fecha o modal
      onClick={onClose}
      role="dialog"
      aria-modal="true"
    >
      <div
        ...
        // Impede que o clique no formulário feche o modal
