...
export const WorkFormModal = ({ isOpen, onClose }) => {
    ...
    >
      ...
      >
        <div className="p-5 border-b border-neutral-700 flex justify-between items-center">
          <h3 id="modal-title" className="text-xl font-bold text-white">Adicionar trabalho</h3>
          <Button
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4 p-5">
          <div className="flex flex-col">
            <label htmlFor="modal-t-date" className="text-neutral-400 text-xs mb-1 font-medium">Nome do trabalho</label>
            <Input
              type="text"
          ...
          <div className="flex flex-col">
            <label htmlFor="modal-t-date" className="text-neutral-400 text-xs mb-1 font-medium">Duração estimada</label>
            <Input
              type="number"
