...
export function DisciplineManualInputStep({ disciplineData, setDisciplineData }) {
  return (
    <div>
      <h2 className="text-neutral-600 flex items-center text-xl font-bold mb-4  pb-2 truncate">Insira manualmente</h2>
      <form className="space-y-4">
        <DisciplineForm disciplineData={disciplineData} setDisciplineData={setDisciplineData} />
      </form>
    </div>
  )
}
