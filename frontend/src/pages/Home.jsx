        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 pt-10">
          ...
          <div className="lg:w-1/2 p-6 bg-neutral-700 rounded-xl border border-neutral-600 shadow-2xl relative min-h-[300px]">
            ...
            <div className="h-64 bg-neutral-800 rounded-lg flex items-center justify-center p-2 mt-8">
              ...
              <div className="grid grid-cols-5 gap-1 w-full h-full text-[10px] font-semibold">
                {['SEG', 'TER', 'QUA', 'QUI', 'SEX'].map((day, i) => (
                  <div key={day} className="flex flex-col">
                    ...
                    <div className="flex-grow flex flex-col justify-start space-y-1">
                      ...
                      {i === 0 && <div className="h-1/5 bg-blue-800 text-white flex items-center justify-center rounded-sm px-0.5 whitespace-nowrap overflow-hidden">Aula Cálculo</div>}
             
                      {i === 1 && <div className="h-1/4 bg-orange-600 text-white flex items-center justify-center rounded-sm px-0.5 whitespace-nowrap overflow-hidden">Trabalho Prog</div>}
              
                      {i === 3 && <div className="h-1/4 bg-green-700 text-white flex items-center justify-center rounded-sm px-0.5 whitespace-nowrap overflow-hidden">Revisão Física</div>}
           
                      <div className="h-1/6 bg-neutral-600 rounded-sm"></div>
       
                      {i === 4 && <div className="h-1/4 bg-orange-600 text-white flex items-center justify-center rounded-sm px-0.5 whitespace-nowrap overflow-hidden">Prova Port.</div>}
            ...
            <p className="text-center text-xs text-neutral-500 mt-3">Visualização Semanal Otimizada por I.A.</p>
          </div>
        </div>
              ...
              <div className="h-40 p-1">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex h-6 w-full relative">
                    <div className="bg-red-700 w-[55%] rounded-l-md" title="Tempo Alocado"></div>
                    <div className="bg-red-900 w-[45%] rounded-r-md" title="Tempo Restante Necessário"></div>
                    <span className="absolute left-0 top-0 h-full flex items-center pl-2 text-white text-xs">55% Alocado</span>
                  </div>
              ...
              <ul className="space-y-4 text-neutral-400">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm">Ao final do dia, confirmamos as tarefas realizadas.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
